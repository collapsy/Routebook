...
| RB-INC-043 | Núcleo de Planning Conflict e Detecção Determinística | Implementation Increment | Draft | 0.2.0 | [rb-inc-043-planning-conflict-core.md](./implementation/increments/rb-inc-043-planning-conflict-core.md) |
| RB-CTX-043 | Context Pack do RB-INC-043 | Implementation Context Pack | Draft | 0.2.0 | [rb-inc-043-planning-conflict-core.md](./implementation/context-packs/rb-inc-043-planning-conflict-core.md) |
