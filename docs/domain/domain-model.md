...
classDiagram
    ...
    PlanningConflict "*" --> "1" Trip : avalia
    PlanningConflict "*" --> "0..1" Itinerary : pode avaliar
    PlanningConflict "*" --> "0..1" ItineraryProposal : pode avaliar
```
...
### 83. Severidades do Conflito de Planejamento
...
### 84. Estados do Conflito de Planejamento
...
#### Regras de estado do Conflito de Planejamento
...
### 85. Referências do Conflito de Planejamento

`PlanningConflict` pode referenciar:
...
O contexto `Planning Assurance` possui os Conflitos de Planejamento e avalia o Roteiro.
...
classDiagram
    ...
    PlanningConflict *-- ConflictRuleReference
    PlanningConflict *-- "1..*" ConflictEvidence
    PlanningConflict o-- "0..1" ConflictResolution
    PlanningConflict --> "0..1" Itinerary : avalia
    PlanningConflict --> "0..*" Activity : afeta
    PlanningConflict --> "0..1" ItineraryProposal : avalia
```
...
flowchart TB
    ...
    PlanningConflict["PlanningConflict"]
    ...
    PlanningConflict -.->|avalia| Itinerary
    PlanningConflict -.->|avalia| Proposal
