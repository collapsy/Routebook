...
| RB-INC-058 | RB-BR-PRP-004, RB-BR-PRP-008, ciclo oficial e RB-DATA-001 | #132 | `codex/rb-inc-058-temporal-expiration`, PR pendente | expiração temporal de Proposal `ready` no domínio | 53 testes do módulo; docs, lint, tipagem e build verdes; CI pendente | Em execução |
