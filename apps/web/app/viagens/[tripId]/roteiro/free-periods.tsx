...
export function FreePeriodComposer({ itinerary, tripId }: { itinerary: Itinerary; tripId: string }) {
  return (
...
export function FreePeriodList({ freePeriods, dayId }: { freePeriods: FreePeriod[]; dayId: string }) {
