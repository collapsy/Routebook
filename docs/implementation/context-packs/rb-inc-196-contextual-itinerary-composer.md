...
- reconciliação final: somente os 16 arquivos reais do incremento foram reaplicados sobre a base consolidada, sem transportar o histórico empilhado da PR `#465`;
