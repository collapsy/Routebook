...
| RB-INC-044 | RB-FR-105, RB-FR-107–110, RB-SCR-010, RB-UF-021, RB-INT-070–074 | #100 | `codex/rb-inc-044-planning-conflicts-experience`, PR pendente | Revisão contextual, read model, filtros e estados | evidências pendentes | Em execução |
