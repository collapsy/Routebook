...
| RB-INC-004 | Visão Inicial da Viagem | Implementation Increment | Draft | 0.1.0 | [rb-inc-004-trip-overview.md](./implementation/increments/rb-inc-004-trip-overview.md) |
