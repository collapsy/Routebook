...
| RB-INC-061 | RB-BR-PRP-004, RB-BR-PRP-008, RB-SCR-009, RB-INT-063–069 e RB-INC-057–060 | #138 | `codex/rb-inc-061-expired-review`, PR pendente | revisão histórica somente leitura da Proposal `expired` sem aplicação | 163 docs, 59 testes web, lint, typecheck e build locais verdes; CI pendente | Em validação |
