...
| RB-INC-055 | RB-BR-PRP-002–005, RB-DATA-001–002, RB-ADR-006, decisão #123 | #126 | `codex/rb-inc-055-ready-persistence`, PR pendente | migration, schema e round trip transacional do conteúdo `ready` | testes e validações pendentes | Em execução |
