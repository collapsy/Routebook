...
| RB-INC-069 | RB-ADR-027, RB-BR-PRP-006, RB-BR-PRP-009–010, RB-DATA-001–002 e RB-INC-068 | #159 | `feature/rb-inc-069-proposal-application-core`, PR pendente | núcleo de Proposal Application, fingerprint idempotente e lifecycle auditável | testes unitários e workflows pendentes | Em execução |
