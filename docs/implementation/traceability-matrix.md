...
| RB-INC-059 | RB-BR-PRP-004, RB-BR-PRP-008, RB-DATA-001–002, RB-ADR-006 e RB-INC-058 | #134 | `codex/rb-inc-059-expired-persistence`, PR pendente | migration, schema e round trip de Proposal `expired` com conteúdo preservado | validações locais verdes; migration e suíte PostgreSQL pendentes no CI | Em execução |
