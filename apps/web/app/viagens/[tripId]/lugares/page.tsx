...
function placeActionErrorMessage(value?: string): string | undefined {
  switch (value) {
    ...
    case "candidato-rejeitado":
      return "Não foi possível adicionar este lugar à Minha seleção. Atualize a busca ou escolha outra opção.";
    ...
    case "consistencia":
    case "erro-tecnico":
      return "Não foi possível atualizar Minha seleção agora. Tente novamente.";
    default:
      return undefined;
  }
}
  ...
  return (
    ...
    >
      ...
      <div className={styles.cardIdentity}>
        ...
        {preference ? <span>{tripPlaceIntentLabels[preference.intent]}</span> : null}
        {preference?.priority === "MUST_DO" ? <span>Imperdível</span> : null}
      </div>
    ...
    >
      ...
      <details className={styles.cardDetails}>
        ...
        <div className={styles.cardDetailsBody}>
          ...
          {!candidate.category ? (
            <small>Adicionar à Minha seleção ainda não está disponível para este lugar.</small>
          ) : null}
          <div className={styles.cardAuxiliaryActions}>
            <a
              className="product-secondary-action"
            ...
            item.kind === "external" ? (
              ...
              <CanonicalDiscoveryCard
                ...
                {...(categoryRankByItemId.has(item.id)
                  ...
                  : {})}
                distanceReferenceLabel={distanceReferenceLabel}
                preference={preferenceByPlaceId.get(item.place.id) ?? null}
                item={item}
                timeZone={trip.destination.timeZone}
                tripId={tripId}
                {...(destinationId ? { destinationId } : {})}
