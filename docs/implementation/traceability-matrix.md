...
| RB-INC-064 | RB-BR-PRP-001, RB-BR-PRP-004, ciclo oficial e RB-INC-050, RB-INC-060, RB-INC-062–063 | #144 | `codex/rb-inc-064-rejection-command`, PR pendente | comando de aplicação para rejeitar e persistir Proposal `ready` | validações locais verdes; suíte integral pendente no CI | Em execução |
