...
| RB-ADR-007 | Adoção de Arquitetura Orientada a Eventos com Outbox para Efeitos Assíncronos Confiáveis | Architecture Decision Record | Published | 0.1.0 | [rb-adr-007-event-driven-architecture-with-outbox-for-reliable-async-side-effects.md](./architecture/adrs/rb-adr-007-event-driven-architecture-with-outbox-for-reliable-async-side-effects.md) |
| RB-ADR-008 | Adoção de Inngest para Orquestração Assíncrona e Jobs Duráveis | Architecture Decision Record | Published | 0.1.0 | [rb-adr-008-inngest-for-async-orchestration-and-durable-jobs.md](./architecture/adrs/rb-adr-008-inngest-for-async-orchestration-and-durable-jobs.md) |
| RB-ADR-009 | Adoção de Redis Gerenciado para Cache Distribuído, Rate Limiting e Estado Efêmero | Architecture Decision Record | Published | 0.1.0 | [rb-adr-009-managed-redis-for-distributed-cache-rate-limiting-and-ephemeral-state.md](./architecture/adrs/rb-adr-009-managed-redis-for-distributed-cache-rate-limiting-and-ephemeral-state.md) |
| RB-ADR-010 | Adoção de Tailwind CSS com CSS Variables e Tokens Semânticos | Architecture Decision Record | Published | 0.1.0 | [rb-adr-010-tailwind-css-with-css-variables-and-semantic-tokens.md](./architecture/adrs/rb-adr-010-tailwind-css-with-css-variables-and-semantic-tokens.md) |
| RB-ADR-011 | Adoção de Vitest, Testing Library e Playwright como Stack de Testes | Architecture Decision Record | Published | 0.1.0 | [rb-adr-011-vitest-testing-library-and-playwright-as-test-stack.md](./architecture/adrs/rb-adr-011-vitest-testing-library-and-playwright-as-test-stack.md) |
| RB-ADR-012 | Adoção de Provedor Gerenciado de E-mail Transacional | Architecture Decision Record | Published | 0.1.0 | [rb-adr-012-managed-transactional-email-provider.md](./architecture/adrs/rb-adr-012-managed-transactional-email-provider.md) |
| RB-ADR-013 | Adoção de Observabilidade Estruturada com Sentry, OpenTelemetry e Logs JSON | Architecture Decision Record | Published | 0.1.0 | [rb-adr-013-structured-observability-with-sentry-opentelemetry-and-json-logs.md](./architecture/adrs/rb-adr-013-structured-observability-with-sentry-opentelemetry-and-json-logs.md) |
| RB-ADR-014 | Adoção de Flags e Configuração Remota por Provider Abstrato | Architecture Decision Record | Published | 0.1.0 | [rb-adr-014-feature-flags-and-remote-configuration-via-provider-abstraction.md](./architecture/adrs/rb-adr-014-feature-flags-and-remote-configuration-via-provider-abstraction.md) |
| RB-ADR-015 | Adoção de Armazenamento de Objetos Compatível com S3 para Uploads e Artefatos | Architecture Decision Record | Published | 0.1.0 | [rb-adr-015-s3-compatible-object-storage-for-uploads-and-artifacts.md](./architecture/adrs/rb-adr-015-s3-compatible-object-storage-for-uploads-and-artifacts.md) |
| RB-ADR-016 | Adoção de OpenAI com Structured Outputs e Camada de Abstração de Modelos | Architecture Decision Record | Published | 0.1.0 | [rb-adr-016-openai-with-structured-outputs-and-model-abstraction-layer.md](./architecture/adrs/rb-adr-016-openai-with-structured-outputs-and-model-abstraction-layer.md) |
| RB-ADR-017 | Adoção de Google Maps Platform como Provider Primário de Mapas e Lugares | Architecture Decision Record | Published | 0.1.0 | [rb-adr-017-google-maps-platform-as-primary-maps-and-places-provider.md](./architecture/adrs/rb-adr-017-google-maps-platform-as-primary-maps-and-places-provider.md) |
| RB-ADR-018 | Adoção de OpenRouteService como Fallback de Rotas e Matriz de Distâncias | Architecture Decision Record | Published | 0.1.0 | [rb-adr-018-openrouteservice-as-routing-and-distance-matrix-fallback.md](./architecture/adrs/rb-adr-018-openrouteservice-as-routing-and-distance-matrix-fallback.md) |
| RB-ADR-019 | Adoção de Vercel como Plataforma Primária de Deployment da Aplicação Web | Architecture Decision Record | Published | 0.1.0 | [rb-adr-019-vercel-as-primary-web-deployment-platform.md](./architecture/adrs/rb-adr-019-vercel-as-primary-web-deployment-platform.md) |
| RB-ADR-020 | Adoção de Supabase como PostgreSQL/PostGIS Gerenciado e Camada de Auth | Architecture Decision Record | Published | 0.1.0 | [rb-adr-020-supabase-as-managed-postgresql-postgis-and-auth-layer.md](./architecture/adrs/rb-adr-020-supabase-as-managed-postgresql-postgis-and-auth-layer.md) |
| RB-ADR-021 | Adoção de Cloudflare R2 como Armazenamento de Objetos Compatível com S3 | Architecture Decision Record | Published | 0.1.0 | [rb-adr-021-cloudflare-r2-as-s3-compatible-object-storage.md](./architecture/adrs/rb-adr-021-cloudflare-r2-as-s3-compatible-object-storage.md) |
| RB-ADR-022 | Adoção de OpenAI como Provedor Inicial da Camada de Inteligência Artificial | Architecture Decision Record | Published | 0.1.0 | [rb-adr-022-openai-as-initial-ai-provider.md](./architecture/adrs/rb-adr-022-openai-as-initial-ai-provider.md) |
| RB-ADR-023 | Estratégia de Ambientes, Configuração e Promoção entre Ambientes | Architecture Decision Record | Published | 0.1.0 | [rb-adr-023-environments-configuration-and-promotion-strategy.md](./architecture/adrs/rb-adr-023-environments-configuration-and-promotion-strategy.md) |
