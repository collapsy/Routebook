...
| RB-INC-062 | RB-BR-PRP-001, RB-BR-PRP-004, ciclo oficial, RB-DATA-001 e RB-INC-053 | #140 | `codex/rb-inc-062-reject-proposal`, PR pendente | transição pura de Proposal `ready` para `rejected` | 165 docs, 63 testes do módulo, lint, typecheck e build locais verdes; CI pendente | Em validação |
